			...
			<div class="md:col-span-12 lg:col-span-8 col-span-12">
				...
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<div class="mb-6">
						...
						<div class="mt-4">
							<label class="block text-gray-700 dark:text-white mb-1" for="id_card">
								ID Card
							</label>
							<input wire:model='id_card' accept="image/png, image/jpeg" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" id="address" type="file">
							</input>
							@error('id_card')
								<div class="text-red-500 text-sm">{{ $message }}</div>
							@enderror
						...
						<div class="mt-4">
							<label class="block text-gray-700 dark:text-white mb-1" for="date_of_return">
								Date of Return
							</label>
							<input wire:model='date_of_return' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" id="date_of_return" type="date">
							</input>
					...
					<ul class="grid w-full gap-6 md:grid-cols-2">
						...
						<li>
							<input wire:model='payment_method' class="hidden peer" id="hosting-big" type="radio" value="credit">
